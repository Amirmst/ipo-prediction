...
missing = 0
with open('../ready_for_preprocessing.csv', mode='r', encoding='latin1') as source_file:
    csvreader = csv.reader(source_file)
    fields = next(csvreader)

    with open('../ready_for_preprocessing_description.csv', mode='w', encoding='utf-8') as dest_file:
